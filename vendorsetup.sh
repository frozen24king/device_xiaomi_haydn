...
git clone https://github.com/frozen24king/device_xiaomi_sm8350-common -b evo-13-dv device/xiaomi/sm8350-common
...
git clone https://github.com/frozen24king/vendor_xiaomi_sm8350-common -b lineage-20-dv vendor/xiaomi/sm8350-common
